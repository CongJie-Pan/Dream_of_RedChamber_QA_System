"""
Optimization module for the LightRAG reasoning agent.
...
class QueryOptimizer:
    ...
    def optimize_retrieval_parameters(self, query: str, sub_question: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "relate" in sq_text.lower() or "connection" in sq_text.lower() or "relationship" in sq_text.lower():
            default_params["retrieval_method"] = "knowledge_graph"
