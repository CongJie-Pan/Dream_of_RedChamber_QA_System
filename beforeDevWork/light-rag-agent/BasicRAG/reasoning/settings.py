"""
Settings module for the BasicRAG reasoning system.
...
class ReasoningSettings:
    ...
    retrieval_parameters: Dict[str, Any] = field(default_factory=lambda: {
        ...
        "retrieval_method": "vector",  # BasicRAG only supports vector retrieval
        "use_reranking": True  # Use reranking for better result ordering
    })
...
class SettingsManager:
    ...
    def load_settings(self) -> bool:
        ...
        if os.path.exists(self.settings_path):
            try:
                ...
                # Ensure BasicRAG specific settings
                if "retrieval_method" in self.settings.retrieval_parameters:
                    self.settings.retrieval_parameters["retrieval_method"] = "vector"
    ...
    def update_settings(self, settings_update: Dict[str, Any]) -> bool:
        ...
        # Ensure BasicRAG specific settings
        if "retrieval_parameters" in settings_update and "retrieval_method" in settings_update["retrieval_parameters"]:
            # Always force vector retrieval for BasicRAG
            self.settings.retrieval_parameters["retrieval_method"] = "vector"
