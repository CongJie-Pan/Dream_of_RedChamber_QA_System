...
class ReasoningAgent:
    ...
    def determine_strategy(self, subproblem: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Define a default strategy - BasicRAG only supports vector search
        default_strategy = {
            "top_k": 5,
            "method": "vector_search",  # BasicRAG only supports vector search
            "filters": {}
        }
        ...
        # Note: BasicRAG doesn't support knowledge graph, so we don't change the method
